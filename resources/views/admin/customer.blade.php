                                ...
                                <div class="block">
                                    ...
                                    <div class="block-section text-center">
                                        <a href="javascript:void(0)">
                                            <img src="/adminn/img/placeholders/avatars/avatar4@2x.jpg" alt="avatar" class="img-circle">
                                        </a>
                                        <h3>
                                            <strong>CEDRIC GLOTHELO</strong><br><small></small>
                                        </h3>
                                    </div>
                                ...
                                <div class="block">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <a href="javascript:void(0)" class="widget widget-hover-effect2 themed-background-muted-light">
                                                <div class="widget-simple">
                                                    <img src="/adminn/img/placeholders/avatars/avatar12.jpg" alt="avatar" class="widget-image img-circle pull-left">
                                        ...
                                        <div class="col-lg-6">
                                            <a href="javascript:void(0)" class="widget widget-hover-effect2 themed-background-muted-light">
                                                <div class="widget-simple">
                                                    <img src="/adminn/img/placeholders/avatars/avatar2.jpg" alt="avatar" class="widget-image img-circle pull-left">
                                                    <h4 class="widget-content text-right">
