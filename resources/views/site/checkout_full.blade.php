...
<div class="main-content shop-page checkout-page">
    <div class="container">
        <div class="breadcrumbs">
            ...
            \ <span class="current">FULL CHECKOUT</span>
        </div>


        <!-- //login form  -->
        <form class="" action="{{ route('checkout.login') }}" method="post">
            @csrf
        ...
        <!-- register / -->
        <form class="" action="{{ route('checkout.full.store') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-12">
                                                    ...
                                                    <div class="col-xs-12 col-md-4 col-lg-5">
                                                        <div class="m-l-20">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                class="flat-red ref_radio" value="no" checked>
