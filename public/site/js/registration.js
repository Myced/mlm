$(document).ready(function(){
    ...
    function verifyRef(ref)
    {
        ...
        $.ajax({
            ...
            error : function(e)
            {
                var message = "Could not verify Referrer. <br>" +
        ...
        $('.ref_radio').each(function(){
            ...
            if(status == true)
            {
                ...
                if(theValue == "no")
                {
                    ...
                    if($ref_id.val() == "")
                    {
                        notificationMessage = "You have selected that you were referred by"
                         + " someone. You need to enter the referral code and click on verify";
                        ...
                        if($ref_name.val() == "")
                        {
                            if($ref_id.hasClass("error-form"))
                            {
                                notificationMessage = "The ref code you entered is wrong. "
                                ...
                                notificationMessage = "Please click on the verify button below "
                                    + " to verify the referrer code";
