...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="" action="{{ route('orders.filter.period') }}" method="get">
                <div class="row">
                    <div class="col-md-4">
                        <input type="text" name="start" class="form-control input-datepicker"
                            placeholder="YYYY-mm-dd - Start Date"
                            data-date-format="yyyy-mm-dd">

                        <input type="text" name="end" class="form-control input-datepicker"
